...
int ht_remove_entryByPointer(PHASH_TABLE pTable, PHASH_TABLE_ENTRY pEntry)
{
	PHASH_TABLE_ENTRY _pEntry, * ppNext;

	ppNext = &pTable->pEntries[pEntry->id % pTable->size];
	_pEntry = *ppNext;
